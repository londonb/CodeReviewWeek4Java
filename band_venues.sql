...
--
-- Name: shows; Type: TABLE; Schema: public; Owner: Guest; Tablespace: 
--
...
ALTER TABLE shows OWNER TO "Guest";

--
-- Name: shows_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--
...
ALTER TABLE shows_id_seq OWNER TO "Guest";

--
-- Name: shows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--
...
--
-- Data for Name: shows; Type: TABLE DATA; Schema: public; Owner: Guest
--

COPY shows (id, band_id, venue_id) FROM stdin;
1	1	1
\.


--
-- Name: shows_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Guest
--

SELECT pg_catalog.setval('shows_id_seq', 2, true);
...
--
-- Name: shows_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--
